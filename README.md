...
- [ ] `CASE {COLUMN} WHEN {VALUE|OPERATION} THEN {VALUE|SUBQUERY} ELSE {VALUE|SUBQUERY} END`
...
- [x] `{COLUMN|FUNCTION|SUBQUERY} = {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} != {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} > {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} >= {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} < {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} <= {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} LIKE {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} REGEXP {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} BETWEEN {VALUE|SUBQUERY} AND {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} IN {VALUE|SUBQUERY}`
- [x] `{COLUMN|FUNCTION|SUBQUERY} NOT IN {VALUE|SUBQUERY}`
- [x] `{COLUMN|SUBQUERY} IS NULL`
- [x] `{COLUMN|SUBQUERY} IS NOT NULL`

##### Nonscalar

- [x] `{COLUMN|FUNCTION} = ALL {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} != ALL {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} > ALL {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} >= ALL {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} < ALL {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} <= ALL {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} = ANY {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} != ANY {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} > ANY {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} >= ANY {SUBQUERY}`
- [x] `{COLUMN|FUNCTION} < ANY {SUBQUERY}`
